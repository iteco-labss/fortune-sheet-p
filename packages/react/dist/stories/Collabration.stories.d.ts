...
declare const _default: import("@storybook/types").ComponentAnnotations<import("@storybook/react/dist/types-0a347bb9").R, import("@fortune-sheet/core").Settings & {
    ...
    getCellValue: (row: number, column: number, options?: import("../packages/core/src/api").CommonOptions & {
        type?: "rt" | "mc" | "v" | "m" | "f" | "ct" | "qp" | "spl" | "bg" | "lo" | "ps" | "hl" | keyof import("@fortune-sheet/core").CellStyle | undefined;
    }) => any;
    ...
    setCellFormat: (row: number, column: number, attr: "rt" | "mc" | "v" | "m" | "f" | "ct" | "qp" | "spl" | "bg" | "lo" | "ps" | "hl" | keyof import("@fortune-sheet/core").CellStyle, value: any, options?: import("../packages/core/src/api").CommonOptions) => void;
    autoFillCell: (copyRange: import("@fortune-sheet/core").SingleRange, applyRange: import("@fortune-sheet/core").SingleRange, direction: "left" | "up" | "down" | "right") => void;
    ...
    getCellsByRange: (range: Selection, options?: import("../packages/core/src/api").CommonOptions) => (import("@fortune-sheet/core").Cell | null)[][];
    ...
    setCellFormatByRange: (attr: "rt" | "mc" | "v" | "m" | "f" | "ct" | "qp" | "spl" | "bg" | "lo" | "ps" | "hl" | keyof import("@fortune-sheet/core").CellStyle, value: any, range: import("@fortune-sheet/core").SingleRange | import("@fortune-sheet/core").Range, options?: import("../packages/core/src/api").CommonOptions) => void;
...
export declare const Example: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0a347bb9").R, import("@fortune-sheet/core").Settings & {
    onChange?: ((data: Sheet[]) => void) | undefined;
    onOp?: ((op: Op[]) => void) | undefined;
} & React.RefAttributes<{
    applyOp: (ops: Op[]) => void;

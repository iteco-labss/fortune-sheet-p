  ...
  var getToolbarItem = useCallback(function (name, i) {
    ...
    if (name === "format") {
      ...
      if (cell) {
        ...
        var format = _.find(defaultFmt, function (v) {
      ...
      return /*#__PURE__*/React.createElement(Combo, {
        ...
        return /*#__PURE__*/React.createElement(Select, null, defaultFmt.map(function (_ref2, ii) {
          var text = _ref2.text,
              value = _ref2.value,
...
var Workbook = /*#__PURE__*/React.forwardRef(function (_ref, ref) {
  ...
  var _useState = useState(defaultContext(globalCache.current)),
      _useState2 = _slicedToArray(_useState, 2),
  ...
  var setContextWithProduce = useCallback(function (recipe) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    setContext(function (ctx_) {
      var _produceWithPatches = produceWithPatches(ctx_, recipe),

...
export declare function convertCssToStyleList(cssText: string): CellStyle;
export declare function convertSpanToShareString($dom: NodeListOf<HTMLSpanElement>): CellStyle[];
